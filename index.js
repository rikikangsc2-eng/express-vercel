...
// Serve documentation page with FontAwesome icons
app.get('/', (req, res) => {
    res.send(`
        <html>
            <head>
            ...
            <body>
                ...
                <div class="endpoint">
                    <p><i class="fas fa-reply"></i> <strong>GET /:username/answer/:answer</strong> - Answer the question and check if the user won</p>
...
app.get('/:username/answer/:answer', async (req, res) => {
    ...
    if (akinator.isWin) {
        res.json({
            message: 'Congratulations!',
            win: true,
            suggestion_name: akinator.suggestion_name,
            suggestion_desc: akinator.suggestion_desc,
            suggestion_photo: akinator.suggestion_photo
        });
    } else {
        res.json({
